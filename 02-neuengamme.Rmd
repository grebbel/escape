...
m <- leaflet() %>% setView(lng=10.233499066, lat=53.4249983, zoom=8) %>%
  addTiles() %>% # Add default OpenStreetMap map tiles
  addMarkers(lng=10.233499066, lat=53.4249983, popup="Neuengamme concentration camp")
m  # Print the map
```
